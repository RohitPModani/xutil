...
export const CITY_TIMEZONES: TimezoneGroup[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Africa/Lome", label: "Togo / Lomé (GMT)", abbreviation: "GMT" },
      {
        value: "Africa/Tunis",
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Asia/Qatar", label: "Qatar / Doha (AST)", abbreviation: "AST" },
      {
        value: "Asia/Riyadh",
  ...
  },
  {
    ...
    options: [
      ...
      { value: "GMT", label: "GMT (Greenwich Mean Time)", abbreviation: "GMT" },
      {
        value: "Etc/GMT+12",
      ...
      { value: "Pacific/Guam", label: "Guam (ChST)", abbreviation: "ChST" },
    ],
  },
];
