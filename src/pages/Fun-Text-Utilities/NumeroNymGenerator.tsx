    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-8 section">
        ...
        <SectionCard>
          ...
          <ErrorBox
            message={error}
            id={error ? "numeronym-error" : undefined}
          />
        </SectionCard>
        ...
        <SectionCard className="mt-6">
          ...
          <div className="prose text-zinc-900 dark:text-white ">
            <p className="mb-4">
              Numeronyms are abbreviations where the middle letters are replaced
              with their count. Commonly used in tech (like i18n for
              "internationalization" or a11y for "accessibility").
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <strong className="text-zinc-900 dark:text-white">i18n</strong>{" "}
                - internationalization (18 letters between i and n)
              </li>
              <li>
                <strong className="text-zinc-900 dark:text-white">l10n</strong>{" "}
                - localization (10 letters between l and n)
              </li>
              <li>
                <strong className="text-zinc-900 dark:text-white">k8s</strong> -
                kubernetes (8 letters between k and s)
              </li>
              <li>
                <strong className="text-zinc-900 dark:text-white">a11y</strong>{" "}
