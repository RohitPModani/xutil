            ...
            <div className="result-box">
              ...
              <div className="scrollbox mt-2">
                <div className="inner-result">
                  <div className="w-full mono-output" aria-label="LeetSpeak translation">
                    {output}
                  </div>
                </div>
              </div>
        ...
        <SectionCard className="mt-6">
          ...
          <div className="prose">
            <ul className="text-zinc-900 dark:text-white pl-5 space-y-2">
              <li>LeetSpeak (or "1337") is an alternative alphabet that replaces letters with similar-looking numbers or special characters</li>
              <li>Originally used by hackers and gamers to bypass text filters or appear elite</li>
              <li>Now commonly used in internet culture for stylistic purposes</li>
              <li>Example: "leet" becomes "1337" or "l33t"</li>
              <li>This translator creates randomized LeetSpeak variations for more authentic results</li>
            </ul>
          </div>
        </SectionCard>
