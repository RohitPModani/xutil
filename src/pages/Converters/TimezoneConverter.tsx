    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-8 section">
        ...
        <SectionCard className="mb-4">
          <div className="flex items-center justify-between mb-4">
            <SectionHeader sectionKey="savedTimezones" />
            <button
        ...
        <SectionCard className="mb-4">
          <div className="flex items-center justify-between mb-4">
            <SectionHeader sectionKey="timezoneConverter" />
            <ClearButton
              onClick={handleClear}
        ...
        <SectionCard className="mb-4">
          <div className="flex items-center justify-between mb-4">
            <SectionHeader sectionKey="multipleTimezoneConverter" />
            <ClearButton
        ...
        <SectionCard className="mb-4">
          <div className="flex items-center justify-between mb-4">
            <SectionHeader sectionKey="multipleTimezoneRangeConverter" />
            <ClearButton
