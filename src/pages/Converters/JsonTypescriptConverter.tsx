...
function JSONTypescriptConverter() {
  ...
  const [fileInterfaceName, setFileInterfaceName] = useState('Data');
  ...
  const handleTextConversion = async () => {
    ...
    try {
      const endpoint = '/json-ts/json-to-typescript'

      const payload = { json_data: textInput, interface_name: interfaceName }
  ...
  const handleFileConversion = async () => {
    ...
    try {
      ...
      formData.append('interface_name', fileInterfaceName);
      ...
      const endpoint = '/json-ts/json-to-typescript-file';
  ...
  return (
    <>
      <PageSEO title="JSON to Typescript Converter" description="Convert JSON to Typescript interface." />
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <SectionCard className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold">JSON ➔ TypeScript Interface (Text Conversion)</h3>
        ...
        <SectionCard className="mt-6">
          <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold">JSON ➔ Typescript (File Conversion)</h3>
            ...
            <div className="flex-1 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <DownloadButton
                      content={fileResult}
                      fileName={`${fileBaseName}_converted.txt`}
                      fileType='txt'
                      disabled={!fileResult}
                    />
                  </div>
