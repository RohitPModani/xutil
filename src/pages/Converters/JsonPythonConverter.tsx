...
function JSONPythonClassConverter() {
  ...
  const handleTextConversion = async () => {
    ...
    try {
      const endpoint = '/json-python/json-to-python'
  ...
  const handleFileConversion = async () => {
    ...
    try {
      ...
      const endpoint = '/json-python/json-to-python-file';
  ...
  return (
    <>
      <PageSEO title="JSON to Python Class Converter" description="Convert JSON to Python class." />
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <SectionCard className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold">JSON ➔ Python Class (Text Conversion)</h3>
        ...
        <SectionCard className="mt-6">
          <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold">JSON ➔ Python Class (File Conversion)</h3>
