...
const VALIDATION_MESSAGE =
  "Value must be greater than zero for L/100km, non-negative for other units";
...
function FuelEconomyConverter() {
  ...
  const convertToKmPerLiter = (
    value: number,
    unit: FuelEconomyUnit
  ): number => {
    switch (unit) {
      case "mpg_us":
        return value * CONVERSION.MPG_US_TO_KM_L;
      case "mpg_uk":
        return value * CONVERSION.MPG_UK_TO_KM_L;
      case "km_l":
        return value;
      case "l_100km":
        return 100 / value;
