...
function AreaConverter() {
  ...
  // Use the hook to get formatted result text for "Copy All"
  const allResultsText = useResultText(result, units);
  ...
  const handleConvert = async () => {
    ...
    try {
      const res = await api.post('/area/convert', {
        value: valueNum,
        unit: unit,
      });
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-8 section">
        ...
        <SectionCard>
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-semibold text-zinc-900 dark:text-white">Area Converter</h3>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="result-box mt-1">
              <div className="flex justify-between items-center">
                ...
                {result && (
                  <CopyButton text={allResultsText} copyType="CopyAll" />
                )}
              </div>
              {result && (
